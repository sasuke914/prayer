...
import {
  ...
  LinkedinShareButton, InstapaperShareButton, InstapaperIcon, WhatsappIcon, EmailIcon,
  FacebookIcon,
  TwitterIcon,
  LinkedinIcon
} from 'react-share'
        ...
        <Container className={`p-5`}>
          ...
          <div className='m-4' style={{ justifyContent: 'space-between' }}>
            <div className="social-share-buttons" style={{ display: 'flex', justifyContent: 'space-around' }}>
              ...
              <WhatsappShareButton url={url} title={title} summary={title} source={url}>
                <WhatsappIcon size={50} round />
              </WhatsappShareButton>
              <EmailShareButton url={url} title={title} summary={title} source={url}>
